"""
CTFIG-MVC (Cross-FM Instance Graph) multi-seed runner.

Usage
-----
# All three datasets (default):
python run_ctfig_mvc_multiseed.py --root "E:\\BachelorThesis\\Data\\data(3)\\data"

# A subset:
python run_ctfig_mvc_multiseed.py --datasets bracs iciar --root "E:\\BachelorThesis\\Data\\data(3)\\data"

Ablations via config flags:
python run_ctfig_mvc_multiseed.py --extra-opts TRAINER.CTFIG.NUM_GNN_LAYERS 0
python run_ctfig_mvc_multiseed.py --extra-opts TRAINER.CTFIG.USE_CROSSFM_GNN False

Results: output/ctfig_mvc_experiments/{dataset}_{N}shot_seed{S}/
Evaluate: python evaluate_overnight_results.py --root output/ctfig_mvc_experiments
"""
...
def main():
    parser = argparse.ArgumentParser(description="CTFIG-MVC multi-seed runner")
    ...
    parser.add_argument("--config-file", type=str,
                        default="configs/trainers/ctfig_mvc.yaml")
    parser.add_argument("--output-base", type=str,
                        default="output/ctfig_mvc_experiments")
        ...
        for shots in args.shots:
            for seed in args.seeds:
                ...
                run_and_log(cmd, out_dir, jsonl_path,
                            {"method": "CTFIG-MVC", "dataset": dataset,
