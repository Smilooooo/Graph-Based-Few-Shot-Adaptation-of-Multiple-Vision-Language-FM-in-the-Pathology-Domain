"""
GraphAdapter (single-backbone baseline) multi-seed runner.

Loops over datasets x backbones x shots x seeds (all datasets by default).

Usage
-----
python run_graphadapter_multiseed.py --root "E:\\BachelorThesis\\Data\\data(3)\\data"
python run_graphadapter_multiseed.py --datasets bracs --root "E:\\BachelorThesis\\Data\\data(3)\\data"
python run_graphadapter_multiseed.py --datasets lunghist bracs --backbones biomedclip --shots 4 --seeds 11111

Results: output/graphadapter_experiments/{dataset}_{backbone}_{N}shot_seed{S}/
Evaluate: python evaluate_overnight_results.py --root output/graphadapter_experiments
"""
...
def main():
    parser = argparse.ArgumentParser(description="GraphAdapter multi-seed runner")
        ...
        for backbone in args.backbones:
            ...
            for shots in args.shots:
                for seed in args.seeds:
                    ...
                    cmd = [
                        sys.executable, "train_graphadapter.py",
                    ...
                    run_and_log(cmd, out_dir, jsonl_path,
                                {"method": "GraphAdapter", "backbone": backbone,
