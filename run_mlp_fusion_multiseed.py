"""
MLP Fusion baseline multi-seed runner.

Usage
-----
# All three datasets (default):
python run_mlp_fusion_multiseed.py --root "E:\\BachelorThesis\\Data\\data(3)\\data"

# A subset:
python run_mlp_fusion_multiseed.py --datasets bracs iciar --root "E:\\BachelorThesis\\Data\\data(3)\\data"

Results: output/mlp_fusion_experiments/{dataset}_{N}shot_seed{S}/
Evaluate: python evaluate_overnight_results.py --root output/mlp_fusion_experiments
"""
...
def main():
    parser = argparse.ArgumentParser(description="MLP Fusion multi-seed runner")
    ...
    parser.add_argument("--output-base", type=str,
                        default="output/mlp_fusion_experiments")
        ...
        for shots in args.shots:
            for seed in args.seeds:
                ...
                run_and_log(cmd, out_dir, jsonl_path,
                            {"method": "MLPFusion", "dataset": dataset,
