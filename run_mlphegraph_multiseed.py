"""
MLPHeGraphAdapter (multi-backbone HeGraph) multi-seed runner.

Usage
-----
# All three datasets (default):
python run_mlphegraph_multiseed.py --root "E:\\BachelorThesis\\Data\\data(3)\\data"

# A subset:
python run_mlphegraph_multiseed.py --datasets lunghist bracs --root "E:\\BachelorThesis\\Data\\data(3)\\data"

Results: output/mlphegraph_experiments/{dataset}_{N}shot_seed{S}/
Evaluate: python evaluate_overnight_results.py --root output/mlphegraph_experiments
"""
...
def main():
    parser = argparse.ArgumentParser(description="MLPHeGraphAdapter multi-seed runner")
    ...
    parser.add_argument("--config-file", type=str,
                        default="configs/trainers/mlphegraph.yaml")
    parser.add_argument("--output-base", type=str,
                        default="output/mlphegraph_experiments")
        ...
        for shots in args.shots:
            for seed in args.seeds:
                ...
                run_and_log(cmd, out_dir, jsonl_path,
                            {"method": "MLPHeGraphAdapter", "dataset": dataset,
